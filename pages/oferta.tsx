          ...
          {loading ? (
            ...
            <>
              <Box mt={2}>
                ...
                «Исполнитель») для любого физического или юридического лица
                (далее – «Заказчик»), которое примет настоящее предложение на
              ...
              <Box mt={5}>
                <Box display="flex" justifyContent="flex-end" mb={2}>
                  <Box width="300px">
                    Приложение № 1 к публичной оферте на оказание посреднических
                    и технических услуг от ВиртуалНам
                  </Box>
                </Box>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        оказание услуги Приема СМС на используемый номер в
                        течение 1 месяцев с момента оказания Услуги.
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <Box mt={5}>
                <Box display="flex" justifyContent="flex-end" mb={2}>
                  <Box width="300px">
                    Приложение № 2 к публичной оферте на оказание посреднических
                    и технических услуг от ВиртуалНам
                  </Box>
                </Box>
                ...
                <Box>
                  <List dense>
                    ...
                    <ListItem>
                      <ListItemText>
                        <strong>4.</strong> Список имен отправителей, в
                        отношении которых услуга Приема СМС не
                        предоставляется:DDOnline, MKKDDOnline, PMSM, Tinkoff,
                        PayQR, Denga, Wooppay.com, MOBI.Dengi, Modulbank, Ezaem,
                        denvzaimy, 111, QIWIWallet, YandexMoney, Wallet One,
                        PrivatBank, WebMoney, qppi.ru, PlatiPotom, WM Mini,
                        MoneXy, Eurozaem, MEGAFON, PLATIZA.RU, ekapusta,
                        MoneyClick, Alfa-Bank, INTERKASSA, Beeline, WM Check,
                        MegaFonPRO, Zaymer.ru, QIWI Wallet, QIWI_WALLET,
                        AdminVPS, WalletOne, qppiru, WMMini, PLATIZARU,
                        AlfaBank, MobiDengi, WMCheck, Zaymerru, uBank, QIWI,
                        MegaFon, GreenMoney, LIME-ZAIM, MegaFon_web, MegaFonTV,
                        MigCredit, Moneyman.ru, PLATIZA, QIWI_Wallet,
                        QPPI.RU,SMSfinance, unicom24ru, Vivus.ru, 0500,
                        ActiveBC, LOVIZAIM, MangoMoney, moneyman, POCHTABANK,
                        SPASIBO, MTC
                      </ListItemText>
                    </ListItem>
                  </List>
